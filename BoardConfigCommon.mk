...
TARGET_PREBUILT_PBL := device/stm/stm32mp1-bootloader/prebuilt/fsbl
TARGET_PREBUILT_SBL := device/stm/stm32mp1-bootloader/prebuilt/ssbl
...
TARGET_PREBUILT_TEE := device/stm/stm32mp1-tee/prebuilt/optee_os

# Path to default misc.img (boot control)
# It can be re-generated using miscgen within bootctrl/tool/ directory
TARGET_PREBUILT_MISC := device/stm/stm32mp1/peripheral/bootctrl/tool/misc.img
